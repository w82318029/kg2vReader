...
def main(args):     
    ...
    while (step < state['loop_iters'] and
        ...
        else:##yawa add att_mask
            c, kl_divergence_cost, posterior_mean_variance = train_batch(x_data, x_data_reversed, max_length, x_cost_mask, x_reset, ran_cost_utterance, ran_decoder_drop_mask, att_mask)
        ...
        if start_validation and is_end_of_batch:
                ...
                while True:
                    ...
                    c, kl_term, c_list, kl_term_list, posterior_mean_variance = eval_batch(x_data, x_data_reversed, max_length, x_cost_mask, x_reset, ran_cost_utterance, ran_decoder_drop_mask,att_mask)
