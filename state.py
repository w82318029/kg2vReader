...
def prototype_twitter_HRED():
    ...
    state['train_dialogues'] = "./prepro/Training480wan6wan.dialogues.pkl"#"./dataset_0408/Training0408.dialogues.pkl" #"../TwitterData/Training.dialogues.pkl"
    state['test_dialogues'] = "./prepro/Validation480wan6wan.dialogues.pkl"#"./dataset_0408/Test0408.dialogues.pkl" #"../TwitterData/Test.dialogues.pkl"
    state['valid_dialogues'] = "./prepro/Validation480wan6wan.dialogues.pkl"#"./dataset_0408/Validation0408.dialogues.pkl" #"../TwitterData/Validation.dialogues.pkl"
    state['dictionary'] = "./prepro/Training480wan6wan.dict.pkl"#"./dataset_0408/Training0408.dict.pkl"#"../TwitterData/Dataset.dict.pkl"
    state['save_dir'] = "HREDtwitter480wan_d_wo"#"HREDtwitter320wan_w"
    ...
    state['valid_freq'] = 24000

    state['prefix'] = "TwitterModel_"
    state['updater'] = 'adam'

    state['bidirectional_utterance_encoder'] = False #True

    state['deep_dialogue_input'] = True
    state['deep_out'] = True

    state['bs'] = 200 # If out of memory, modify this!
    state['decoder_bias_type'] = 'all'#'selective' # Choose between 'first', 'all' and 'selective'
    #state['direct_connection_between_encoders_and_decoder'] = False
    #state['deep_direct_connection'] = False

    state['reset_utterance_decoder_at_end_of_utterance'] = True
    state['reset_utterance_encoder_at_end_of_utterance'] = True #False
    state['lr'] = 0.0002
    ...
    state['utterance_decoder_gating'] = 'LSTM'#'GRU'
    
    #yawa add following stuff
    state['initialize_from_pretrained_word_embeddings'] = True
    state['pretrained_word_embeddings_file'] = 'prepro/temb_480wan6wan_only_pretrained_400.pkl'#'GoogleNews-vectors-negative300.bin'
    state['fix_pretrained_word_embeddings'] = False
    return state
...
def prototype_twitter_VHRED():
    ...
    ##########
    # Fill your paths here!
    state['train_dialogues'] = "./prepro/Training480wan6wan.dialogues.pkl"#"../TwitterData/Training.dialogues.pkl"
    state['test_dialogues'] = "./prepro/Validation480wan6wan.dialogues.pkl"#"../TwitterData/Test.dialogues.pkl"
    state['valid_dialogues'] = "./prepro/Validation480wan6wan.dialogues.pkl"#"../TwitterData/Validation.dialogues.pkl"
    state['dictionary'] = "./prepro/Training480wan6wan.dict.pkl"#"../TwitterData/Dataset.dict.pkl"
    state['save_dir'] = "VHREDtwitter480wan_d_wo"#"Output"
    
    ##yawa add 
    state['decoder_drop_previous_input_tokens'] = True
    state['decoder_drop_previous_input_tokens_rate'] = 0.75
    ####
    state['max_grad_steps'] = 74#80
...
def prototype_ubuntu_HRED():
    ...
    state['train_dialogues'] = "Data/Training.dialogues.pkl"#"./Input/Training.dialogues.pkl"
    state['test_dialogues'] = "Data/Test.dialogues.pkl"#"./Input/Test.dialogues.pkl"
    state['valid_dialogues'] = "Data/Validation.dialogues.pkl"#"./Input/Validation.dialogues.pkl"
    state['dictionary'] = "Data/Dataset.dict.pkl"#"./Input/Training.dict.pkl"
    state['save_dir'] = "ubuntu_bi"#"nlpccModel"

    state['max_grad_steps'] = 80

    state['valid_freq'] = 5600
    ...
    #yawa add following
    state['initialize_from_pretrained_word_embeddings'] = True
    state['pretrained_word_embeddings_file'] = 'ubuntu_300_google.pkl'
    state['fix_pretrained_word_embeddings'] = False
    ##
    return state
...
def prototype_158wan_HRED():
    ...
    state['train_dialogues'] = "./150wan.dialogues.pkl"#"./Input/Training.dialogues.pkl"
    state['test_dialogues'] = "./156wanval.dialogues.pkl"#"./Input/Test.dialogues.pkl"
    state['valid_dialogues'] = "./156wanval.dialogues.pkl"#"./Input/Validation.dialogues.pkl"
    state['dictionary'] = "./150wan.dict.pkl"#"./Input/Training.dict.pkl"
    state['save_dir'] = "nlpcc158wan"#"nlpccModel"

    state['max_grad_steps'] = 80

    state['valid_freq'] = 7330

    state['prefix'] = "UbuntuModel_"
    state['updater'] = 'adam'

    state['bidirectional_utterance_encoder'] = True#False
    state['deep_dialogue_input'] = True
    state['deep_out'] = True
    ...
    #yawa add following
    state['initialize_from_pretrained_word_embeddings'] = True
    state['pretrained_word_embeddings_file'] = 'trainMini/temb_0408_320wan_onlyNlpccCorpus_pretrained_300.pkl'#'GoogleNews-vectors-negative300.bin'
    state['fix_pretrained_word_embeddings'] = False
    ##
    return state

def prototype_twitter_HRED_head200wan():
    state = prototype_state()
    ...
    ##########
    # Fill your paths here!
    state['train_dialogues'] = "./prepro/head200wan.dialogues.pkl"#"./dataset_0408/Training0408.dialogues.pkl" #"../TwitterData/Training.dialogues.pkl"
    state['test_dialogues'] = "./prepro/head200val.dialogues.pkl"#"./dataset_0408/Test0408.dialogues.pkl" #"../TwitterData/Test.dialogues.pkl"
    state['valid_dialogues'] = "./prepro/head200val.dialogues.pkl"#"./dataset_0408/Validation0408.dialogues.pkl" #"../TwitterData/Validation.dialogues.pkl"
    state['dictionary'] = "./prepro/head200wan.dict.pkl"#"./dataset_0408/Training0408.dict.pkl"#"../TwitterData/Dataset.dict.pkl"
    state['save_dir'] = "head200wan"#"HREDtwitter320wan_w"
    ...
    state['valid_freq'] = 8000

    state['prefix'] = "TwitterModel_"
    state['updater'] = 'adam'

    state['bidirectional_utterance_encoder'] = True #True

    state['deep_dialogue_input'] = True
    state['deep_out'] = True

    state['bs'] = 250 # If out of memory, modify this!
    state['decoder_bias_type'] = 'all'#'selective' # Choose between 'first', 'all' and 'selective'
    #state['direct_connection_between_encoders_and_decoder'] = False
    #state['deep_direct_connection'] = False
    ...
    #yawa add following stuff
    state['initialize_from_pretrained_word_embeddings'] = True
    state['pretrained_word_embeddings_file'] = 'prepro/temb_head200wan.pkl'#'GoogleNews-vectors-negative300.bin'
    state['fix_pretrained_word_embeddings'] = False
    return state

def prototype_twitter_HRED_tail200wan():
    state = prototype_state()
    ...
    ##########
    # Fill your paths here!
    state['train_dialogues'] = "./prepro/tail200wan.dialogues.pkl"#"./dataset_0408/Training0408.dialogues.pkl" #"../TwitterData/Training.dialogues.pkl"
    state['test_dialogues'] = "./prepro/tail200val.dialogues.pkl"#"./dataset_0408/Test0408.dialogues.pkl" #"../TwitterData/Test.dialogues.pkl"
    state['valid_dialogues'] = "./prepro/tail200val.dialogues.pkl"#"./dataset_0408/Validation0408.dialogues.pkl" #"../TwitterData/Validation.dialogues.pkl"
    state['dictionary'] = "./prepro/tail200wan.dict.pkl"#"./dataset_0408/Training0408.dict.pkl"#"../TwitterData/Dataset.dict.pkl"
    state['save_dir'] = "tail200wan"#"HREDtwitter320wan_w"
    ...
    #yawa add following stuff
    state['initialize_from_pretrained_word_embeddings'] = True
    state['pretrained_word_embeddings_file'] = 'prepro/temb_tail200wan.pkl'#'GoogleNews-vectors-negative300.bin'
    state['fix_pretrained_word_embeddings'] = False
    return state

def prototype_twitter_HRED_450wan5wan():
    state = prototype_state()
    ...
    ##########
    # Fill your paths here!
    state['train_dialogues'] = "/home/wangyanmeng/neroComputiing/nlpccData/pkl/Train450wan5wan.dialogues.pkl"
    state['test_dialogues'] = "/home/wangyanmeng/neroComputiing/nlpccData/pkl/Test450wan5wan.dialogues.pkl"
    state['valid_dialogues'] = "/home/wangyanmeng/neroComputiing/nlpccData/pkl/Val450wan5wan.dialogues.pkl"
    state['dictionary'] = "/home/wangyanmeng/neroComputiing/nlpccData/pkl/Train450wan5wan.dict.pkl"
    state['save_dir'] = "450wan5wan"
    ...
    state['bs'] = 160 # If out of memory, modify this!
    state['decoder_bias_type'] = 'all'#'selective' # Choose between 'first', 'all' and 'selective'
    #state['direct_connection_between_encoders_and_decoder'] = False
    #state['deep_direct_connection'] = False
    ...
    #yawa add following stuff
    state['initialize_from_pretrained_word_embeddings'] = True
    state['pretrained_word_embeddings_file'] = '/home/wangyanmeng/neroComputiing/nlpccData/pkl/temb_450wan5wan.pkl'
    state['fix_pretrained_word_embeddings'] = False
    return state

def prototype_ubuntu_HRED_kg():
    state = prototype_state()
    ...
    ##########
    # Fill your paths here!
    state['train_dialogues'] = "Data/menu/menu1.8wanci.dialogues.pkl"
    state['test_dialogues'] = "Data/menu/menu1.8wanciTest.dialogues.pkl"
    state['valid_dialogues'] = "Data/menu/menu1.8wanciVal.dialogues.pkl"
    state['dictionary'] = "Data/menu/menu1.8wanci.dict.pkl"
    state['save_dir'] = "menu1.8wanci"
    ...
    #yawa add following stuff
    state['initialize_from_pretrained_word_embeddings'] = True
    state['pretrained_word_embeddings_file'] = 'menuAverageWord.pkl'
    state['fix_pretrained_word_embeddings'] = False
    return state
